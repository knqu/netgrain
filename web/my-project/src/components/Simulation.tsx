...
const Simulation: React.FC = () => {
  ...
  const [tradeFee, setTradeFee] = useState<number | string>(1.5);
        ...
        {!isRunning ? (
                    ...
                    <div className="sim-form-row">
                      <div className="sim-form-col">
                        ...
                        <select
                          ...
                          value={stock.ticker}
                          onChange={(e) =>
                            updateStock(index, "ticker", e.target.value)
                          }
                        >
                      ...
                      <div className="sim-form-col">
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            updateStock(index, "base_price", e.target.value)
                          }
                        />
                      </div>
                    </div>
                    ...
                    <div className="sim-form-row" style={{ marginTop: "10px" }}>
                      <div className="sim-form-col">
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            updateStock(index, "volatility", e.target.value)
                          }
                        />
                      </div>
                      <div className="sim-form-col">
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            updateStock(index, "liquidity", e.target.value)
                          }
                        />
                      </div>
                      <div className="sim-form-col">
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            updateStock(index, "market_cap", e.target.value)
                          }
                        />
                      </div>
                    </div>
          ...
          <div className="sim-panel">
            ...
            {runResult ? (
              ...
              >
                ...
                >
                  ...
                  <div style={{ flex: "1" }}>
                    ...
                    >
                      {runResult.config.stocks
                        .map((s: any) => s.ticker || s.name)
                        .join(", ")}
                    </div>
                    <div style={{ fontSize: "12px", color: "#666" }}>
                      Cap: ${runResult.config.initial_capital?.toLocaleString()}{" "}
                      | Fee: ${runResult.config.trade_fee?.toFixed(2)}
                    </div>
                  </div>
                  ...
                  >
                    <div style={{ textAlign: "center" }}>
                      ...
                      <div
                        style={{
                          fontWeight: "bold",
                          color:
                            runResult.metrics.net_profit >= 0 ? "green" : "red",
                        }}
                      >
                    ...
                    <div style={{ textAlign: "center" }}>
                      ...
                      <div style={{ fontWeight: "bold" }}>
                        {runResult.metrics.win_rate_percent?.toFixed(1)}%
                      </div>
                    </div>
                    <div style={{ textAlign: "center" }}>
                      <div
                      ...
                      <div style={{ fontWeight: "bold" }}>
                        {runResult.metrics.total_trades}
                      </div>
                    </div>
                  </div>
                  ...
                  >
                    <button
                      onClick={() => {
                        ...
                        link.href = url;
                        const tickerNames = runResult.config.stocks
                          .map((s: any) => s.ticker || s.name)
                          .join("_");
              ...
              <pre className="sim-status-box">{engineStatus}</pre>
            )}
